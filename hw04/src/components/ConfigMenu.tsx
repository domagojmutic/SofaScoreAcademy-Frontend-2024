...
function ConfigMenu(props: Props) {
  ...
  return (
    <>
      ...
      <motion.div
        className={
          "w-[245px] opacity-0 absolute top-[90px] right-[45px] flex flex-col z-50 rounded-md phone:top-[50px] phone:right-[15px] bg-details-lt dark:bg-header-dt text-text-lt dark:text-text-dt shadow-[0px_0px_16px_0px_#00000040]"
        }
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
